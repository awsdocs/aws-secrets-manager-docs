...
**Secrets Manager currently supports logging all of its API operations as management events in CloudTrail log files\. There are currently no data events\.**
