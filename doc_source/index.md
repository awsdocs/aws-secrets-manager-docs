...
+ [Create and manage secrets with AWS Secrets Manager](managing-secrets.md)
   ...
   + [Create secrets in AWS CloudFormation](integrating_cloudformation.md)
      ...
      + [Create a Secrets Manager secret for an Amazon RDS MySQL DB instance with AWS CloudFormation](cfn-example_RDSsecret_no-rotation.md)
      + [Create a Secrets Manager secret with automatic rotation and an Amazon RDS MySQL DB instance with AWS CloudFormation](cfn-example_RDSsecret.md)
      + [Create a Secrets Manager secret with automatic rotation and an Amazon Redshift cluster with AWS CloudFormation](cfn-example_Redshift-secret.md)
      + [Create a Secrets Manager secret with automatic rotation and an Amazon DocumentDB instance with AWS CloudFormation](cfn-example_DocDB-secret.md)
+ [Retrieve secrets from AWS Secrets Manager](retrieving-secrets.md)
   ...
   + [Retrieve a secret in an AWS CloudFormation resource](cfn-example_reference-secret.md)
...
+ [Monitor AWS Secrets Manager secrets](monitoring.md)
   ...
   + [Monitoring Secrets Manager with Amazon CloudWatch](monitoring-cloudwatch.md)
...
+ [AWS services that use Secrets Manager secrets](integrating.md)
   ...
   + [Secrets managed by other AWS services](service-linked-secrets.md)
